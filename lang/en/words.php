...
return [
    ...
    "sign_in" => "Sign In",
    "sign_in_to_user" => "Create Account",
    "sign_out" => "Sign Out",
    ...
    "sale" => "Big Sale Today",
    "title_checkout" => "Get Ready For Checkout?",
    "checkout" => "Checkout",
    "price" => "Price",
    "quantity" => "Quantity",
    "sub_total" => "SubTotal",
    ...
    "title_new_letters" => "Subscribe Us to for News and Advice.",
    "links" => "Links",
    "show_more" => "Show More",
    "shop_now" => "Shop Now",
    "read_more" => "Read More",
    ...
    "developed" => "Designed and programmed by ",
    'sub_developed' => 'Cyber Life',
    "dt_search" => "Search:",
