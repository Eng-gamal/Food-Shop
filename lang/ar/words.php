...
return [
    ...
    "about" => "من نحن",
    "shop" => "تسوق",
    "our_products" => "منتاجتنا",
    "sale" => "عرض كبير اليوم",
    "title_checkout" => "هل أنت مستعد للدفع؟",
    "checkout" => "أدفع",
    "price" => "السعر",
    "quantity" => "الكمية",
    "sub_total" => "المجموع",
    ...
    "title_new_letters" => "اشترك معنا للحصول على الأخبار والنصائح",
    "links" => "روابطنا",
    ...
    "developed" => "تصميم وبرمجة",
    'sub_developed' => 'سايبر لايف',
    "dt_search" => "بحث:",
