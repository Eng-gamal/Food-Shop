                        ...
                        <tr style="border-collapse:collapse">
                            <td align="center" style="padding:0;Margin:0">
                                <table class="es-footer-body" cellspacing="0" cellpadding="0" align="center"
                                    bgcolor="#054885"
                                    style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#054885;width:600px;color: #ffffff">
                                    <tr style="border-collapse:collapse">
                                        <td align="{{ App::isLocale('ar') ? 'right' : 'left' }}"
                                            style="padding:20px;Margin:0">
                                            <table cellspacing="0" cellpadding="0" width="100%"
