...
class PageSeeder extends Seeder
{
    public function run()
    {
        ...
        $about = Page::create([
            ...
            "ar" => [
                "title" => "حول مزرعتنا",
                "description" => "نعتبر الرواد فى تقديم الخدمات ذات جودة أعلى فى مجال الأنظمة الأمنية والمراقبة والسلامة وتجاوز إحتياجات عملائنا المحددة والمخصصة من خلال تقديم أعلى مستويات الخدمات الأمنية الخاصة والمبنية على الثقة",
            ],
            "en" => [
