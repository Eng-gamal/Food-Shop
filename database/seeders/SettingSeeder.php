    ...
    public function run()
    {
        $setting = Setting::create([
            'ar' => [
                ...
                'footer_description' => 'تأسست شركة لوحة التحكم في المملكة العربية السعودية لتلبية الطلب المتزايد في مجال البناء والتطوير في المملكة العربية السعودية.',
                'address' => ' الرياض، المملكة العربية السعودية',
                'copyrights' => 'جميع الحقوق محفوظة لمتجر الطعام © 2025 .',
            ...
            'en' => [
                ...
                'footer_description' => 'Dashboard was established in Saudi Arabia to meet the ever-growing demand in construction and development in the Kingdom of Saudi Arabia.',
                'address' => 'Riyadh, Kingdom of Saudi Arabia',
                'copyrights' => 'Copyright © 2025 - SHOP FOOD.All Rights Reserved',
                'meta_keywords' => 'Dashboard',
                'meta_title' => 'Dashboard',
                'meta_description' => 'Dashboard Construction',
            ],
            'contact_email' => 'email@website.com',
